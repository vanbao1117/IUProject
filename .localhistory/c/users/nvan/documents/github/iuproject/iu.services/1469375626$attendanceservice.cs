...
namespace IU.Services
{
    public class AttendanceService : IDisposable
    {
        ...
        public async Task<UserAttendancePagingViewModel> GetAttendanceByStudentSync(int pageNumber, int pageSize, string userName, string semesterName)
        {
            using (var context = new IUContext())
            {
                return await Task.Run(() => GetAttendanceByStudent(pageNumber, pageSize, userName));
            }
        }

        private UserAttendancePagingViewModel GetAttendanceByStudent(int pageNumber, int pageSize, string userName)
        {
            using (var context = new IUContext())
            {
