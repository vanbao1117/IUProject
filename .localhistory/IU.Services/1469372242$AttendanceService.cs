...
namespace IU.Services
{
    public class AttendanceService : IDisposable
    {
        ...
        public async Task<List<UserSemesterViewModel>> GetSemesterByStudentSync(string userId)
        {
        ...
        private List<UserSemesterViewModel> GetSemesterByStudent(string userId)
        {
            using (var context = new IUContext())
            {
                ...
                var semesters =
                 ...
                 select new UserSemesterViewModel() { SemesterID = semesterTBLs.SemesterID, SemesterName = semesterTBLs.SemesterName, StartDate = semesterTBLs.StartDate.GetValueOrDefault(), EndDate = semesterTBLs.EndDate.GetValueOrDefault() };
