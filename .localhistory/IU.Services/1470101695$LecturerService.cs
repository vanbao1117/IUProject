...
namespace IU.Services
{
    ...
    {
        public async Task<List<UserAttendanceViewModel>> GetTakeAttendancesSync(string subjectID, string type)
        {
            using (var context = new IUContext())
            {
                return await Task.Run(() => GetTakeAttendances(userName, type));
            }
        }
