...
namespace IU.Services
{
    public class LecturerService : IDisposable
    {
        ...
        public async Task<PreviewListViewModel> GetLectureSubjectAndClassSync(string userName, string classID, string subjectID)
        {
            using (var context = new IUContext())
            {
                return await Task.Run(() => GetLectureSubjectAndClass(userName, classID, subjectID));
            }
        }

        private PreviewListViewModel GetLectureSubjectAndClass(string userName, string classID, string subjectID)
        {
            using (var context = new IUContext())
            {
