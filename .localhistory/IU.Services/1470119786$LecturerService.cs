...
namespace IU.Services
{
    public class LecturerService : IDisposable
    {
        ...
        public async Task<List<UserAttendanceViewModel>> TakeAttendancesSync(List<UserAttendanceViewModel> models)
        {
            using (var context = new IUContext())
            {
                return await Task.Run(() => TakeAttendances(models));
            }
        }

        private List<UserAttendanceViewModel> TakeAttendances(List<UserAttendanceViewModel> models)
        {
