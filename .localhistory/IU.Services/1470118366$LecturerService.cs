...
namespace IU.Services
{
    ...
    {
        public async Task<List<UserAttendanceViewModel>> GetTakeAttendancesSync(string subjectID, string semesterID, string classID, DateTime dateStudy)
        {
            using (var context = new IUContext())
            {
                return await Task.Run(() => GetTakeAttendances(subjectID, semesterID, classID, dateStudy));
            }
        }


        private List<UserAttendanceViewModel> GetTakeAttendances(string subjectID, string semesterID, string classID, DateTime dateStudy)
        {
