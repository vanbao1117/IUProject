        ...
        private bool UpdateClassSchedule(UpdateClassSchedulePageViewModel model, string userName)
        {
            try
            {
                ...
                foreach (StudentListTBL std in studentLists)
                {
                    ...
                    classSchedule.LecturerID = model.NewModel.LecturerID;
                    classSchedule.ClassID = model.NewModel.ClassID;
                    classSchedule.SubjectID = model.NewModel.SubjectID;
                    classSchedule.SlotID = model.NewModel.SlotID;
                    classSchedule.RoomID = model.NewModel.RoomID;
                    classSchedule.Blog = model.NewModel.BlogID;
                    classSchedule.ModeID = model.NewModel.ModeID;
