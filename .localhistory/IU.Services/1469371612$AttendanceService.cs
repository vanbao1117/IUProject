...
namespace IU.Services
{
    public class AttendanceService : IDisposable
    {
        ...
        public async Task<List<UserSubjectViewModel>> GetAttendanceByStudentSync(string userId)
        {
        ...
        private List<UserSubjectViewModel> GetAttendanceByStudent(string userId)
        {
            using (var context = new IUContext())
            {
