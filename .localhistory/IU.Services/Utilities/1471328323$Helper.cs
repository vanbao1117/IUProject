...
namespace IU.Services
{
    ...
    public class Helper
    {
        ...
        public static DateTime[] GetRStudyDays(DateTime start, DateTime end, string modes, int blog)
        {
        ...
        public static IQueryable<T> PagedResult<T, TResult>(IQueryable<T> query, int pageNum, int pageSize,
                        Expression<Func<T, TResult>> orderByProperty, bool isAscendingOrder, out int rowsCount, bool isDistinct = false)
        {
