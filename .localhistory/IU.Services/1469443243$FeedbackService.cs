...
namespace IU.Services
{
    ...
    {
        public async Task<List<LecturerViewModel>> SubmitFeedbackSync(FeedbackViewModel feedback, string userId)
        {
        ...
        private List<LecturerViewModel> SubmitFeedback(FeedbackViewModel feedback, string userId)
        {
            using (var context = new IUContext())
            {
