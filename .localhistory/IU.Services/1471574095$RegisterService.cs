        ...
        private void createClassSchedule(AcceptRegister accept)
        {
            using (var context = new IUContext())
            {
                ...
                //{
                    ...
                    DateTime mondayOffWeek = Helper.FirstDayOfWeek(openSubject.StartDate.Value);
                    TimeSpan diff = studyDatesBlog1[studyDatesBlog1.Length - 1] - mondayOffWeek;
                    int days = diff.Days;
                ...
                //{
                    ...
                    DateTime mondayOffWeek2 = Helper.FirstDayOfWeek(studyDatesBlog2[0]);
                    TimeSpan diff2 = studyDatesBlog2[studyDatesBlog2.Length - 1] - mondayOffWeek2;
                    int days2 = diff2.Days;
                ...
                foreach (DateTime dateStudy in lsStudyDate)
                {
                    ...
                    {
                        Helper.FirstDayOfWeek(dateStudy);
