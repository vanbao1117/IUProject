...
namespace IU.Services
{
    public class LecturerService : IDisposable
    {
        ...
        public async Task<PreviewListViewModel> GetLectureSubjectAndClassSync(string userName)
        {
        ...
        private PreviewListViewModel GetLectureSubjectAndClass(string userName)
        {
            using (var context = new IUContext())
            {
