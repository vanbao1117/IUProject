                ...
                using (var context = new IUContext())
                {
                    var students =
                     (from studentTBLs in context.StudentTBLs
                      ...
                      select new StudentInOpenClassViewModel() { StudentID = studentTBLs.StudentID, ClassID = openClassTBLs.ClassID, ClassName = classTBLs.ClassName, StudentName = studentTBLs.StudentName, Status = acceptRegisters.Accepted == true? "Accepted" : "Pending", StudentBirth = studentTBLs.StudentBirth, StudentCode = studentTBLs.StudentCode });
