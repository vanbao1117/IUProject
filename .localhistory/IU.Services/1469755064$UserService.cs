...
namespace IU.Services
{
    public class UserService : IDisposable
    {
        ...
        public async Task<AspNetUserViewModel> GetUserInfoSync(string username)
        {
            return await Task.Run(() => GetUserInfo(username));
        }

        private AspNetUserViewModel GetUserInfo(string username)
        {
