...
namespace IU.Web.Models
{
    ...
    public class LectureSubjectViewModel
    {
        public string SubjectID { get; set; }
        public string SubjectName { get; set; }
        public string SubjectCode { get; set; }
    ...
    public class LectureSubjectAndClassViewModel
    {
        public List<LectureClassViewModel> LectureClass { get; set; }
        public List<LectureSubjectViewModel> LectureSubject { get; set; }
    }
}
