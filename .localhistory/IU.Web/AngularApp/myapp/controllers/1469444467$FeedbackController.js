...
IUApp.controller('FeedbackController', ['$scope', '$http', '$templateCache', '$timeout', '$routeParams', 'LecturerService', 'FeedbackServices',
    function ($scope, $http, $templateCache, $timeout, $routeParams, LecturerService, FeedbackServices) {
        $scope.lecturers = [];
        ...
        $scope.sendFeedback = function () {
            var feedback = {
                lecturerID: $scope.lecturer.lecturerID, quality: $scope.qualities.quality,
                attitude: $scope.attitudes.attitude, satisfaction: $scope.satisfactions.satisfaction, onTime: $scope.onTimes.onTime, comments: $scope.comments
            };
