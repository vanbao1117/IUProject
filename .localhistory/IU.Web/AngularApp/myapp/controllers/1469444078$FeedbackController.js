...
IUApp.controller('FeedbackController', ['$scope', '$http', '$templateCache', '$timeout', '$routeParams', 'LecturerService', 'FeedbackServices',
    function ($scope, $http, $templateCache, $timeout, $routeParams, LecturerService, FeedbackServices) {
        ...
        $scope.sendFeedback = function () {
            var feedback = {
                lecturerID: $scope.lecturer.lecturerID, quality: $scope.quality,
                attitude: $scope.attitude, satisfaction: $scope.satisfaction, onTime: $scope.onTime, comments: $scope.comments
            };
            FeedbackServices.getLecturer().then(
              function (lecturers) {
                  $scope.lecturers = lecturers;
                  console.log('getLecturer: ', lecturers);
              },
