...
IUApp.controller('FeedbackController', ['$scope', '$http', '$templateCache', '$timeout', '$routeParams', 'LecturerService', 'FeedbackServices', 'sweet',
    function ($scope, $http, $templateCache, $timeout, $routeParams, LecturerService, FeedbackServices, sweet) {
        $scope.lecturers = [];
            ...
            FeedbackServices.submitFeedback(feedback).then(
              function (feedback) {
                  $timeout(function () {
                      ...
                      $scope.onTime = {};
                      $scope.comments = '';
                      window.alert("Thank's for your feedback!");
                  });
