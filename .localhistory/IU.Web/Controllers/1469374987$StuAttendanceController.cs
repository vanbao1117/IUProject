...
namespace IU.Web.Controllers
{
    ...
    public class StuAttendanceController : ApiController
    {
        ...
        // GET api/Schedule/GetAttendanceByStudent
        /// <summary>
        /// Get class Schedule
        /// </summary>
        /// <returns></returns>
        ...
        public async Task<IHttpActionResult> GetAttendanceByStudent(int pageNumber, int pageSize = 20, string abbreSubjectName = "ALL")
        {
            try
            {
